...
import { TabItem } from "./TableItems";
...
export default function SettingsTabs(){
    ...
    return(
        <Tabs.Root value={currentTab} onValueChange={setCurrentTab}>
            <Tabs.List className='mt-6 flex w-full items-center gap-x-4 border-b border-zinc-200'>
              ...
              <TabItem value="tab6" title="Billinng" isSelected={currentTab === 'tab6'} />
